        ...
        try {
          ...
          if (entry.type === 'event_msg' && entry.payload?.type === 'token_count' && entry.payload?.info) {
            ...
            if (info.last_token_usage) {
              tokenUsage = {
                used: info.last_token_usage.input_tokens || info.last_token_usage.total_tokens || 0,
                total: info.model_context_window || 200000
              };
            } else if (info.total_token_usage) {
              tokenUsage = {
                used: info.total_token_usage.input_tokens || info.total_token_usage.total_tokens || 0,
                total: info.model_context_window || 200000
              };
            }
          }
