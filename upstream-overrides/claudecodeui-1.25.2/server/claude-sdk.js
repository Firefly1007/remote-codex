...
function extractTokenBudget(resultMessage) {
  ...
  // Prefer per-request tokens (reflects current context window fill)
  // Fall back to cumulative if per-request unavailable
  ...
  // Total used = input + cache tokens (output tokens don't occupy context window)
