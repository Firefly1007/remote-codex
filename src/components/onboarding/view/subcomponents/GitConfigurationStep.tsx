  ...
  return (
    <div className="space-y-6">
      <div className="mb-8 text-center">
        ...
        <h2 className="mb-2 text-2xl font-bold text-foreground">{t('onboarding.gitConfig')}</h2>
        <p className="text-muted-foreground">
          {t('onboarding.configureGit')}
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          />
          <p className="mt-1 text-xs text-muted-foreground">{t('onboarding.savedAs', { field: 'name' })}</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            disabled={isSubmitting}
          />
          <p className="mt-1 text-xs text-muted-foreground">{t('onboarding.savedAs', { field: 'email' })}</p>
        </div>
      </div>
    </div>
  );
