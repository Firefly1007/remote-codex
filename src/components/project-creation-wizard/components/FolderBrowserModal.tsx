...
export default function FolderBrowserModal({
  ...
  const loadFolders = useCallback(async (pathToLoad: string) => {
    ...
    try {
      ...
      setError(loadError instanceof Error ? loadError.message : t('folder.failedLoad'));
    } finally {
  ...
  const handleCreateFolder = useCallback(async () => {
    ...
    try {
      ...
      setError(createError instanceof Error ? createError.message : t('folder.failedCreate'));
    } finally {
      ...
      <div className="flex max-h-[80vh] w-full max-w-2xl flex-col rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
        <div className="flex items-center justify-between border-b border-gray-200 p-4 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t('folder.selectFolder')}</h3>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              title={showHiddenFolders ? t('folder.hideHidden') : t('folder.showHidden')}
            >
        ...
        {showNewFolderInput && (
          <div className="border-b border-gray-200 bg-blue-50 px-4 py-3 dark:border-gray-700 dark:bg-blue-900/20">
            <div className="flex items-center gap-2">
              ...
              >
                {creatingFolder ? <Loader2 className="h-4 w-4 animate-spin" /> : t('folder.create')}
              </Button>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2 bg-gray-50 px-4 py-3 dark:bg-gray-900/50">
            <span className="text-sm text-gray-600 dark:text-gray-400">{t('folder.path')}</span>
