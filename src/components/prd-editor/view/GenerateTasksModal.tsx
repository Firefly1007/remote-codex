        ...
        <div className="space-y-4 p-6">
          <div className="rounded-lg border border-purple-200 bg-purple-50 p-4 dark:border-purple-800 dark:bg-purple-900/20">
            ...
            <div className="rounded border border-purple-200 bg-white p-3 dark:border-purple-700 dark:bg-gray-800">
              <p className="mb-1 text-xs font-medium text-gray-600 dark:text-gray-400">{t('prd.examplePrompt')}</p>
              <p className="font-mono text-xs text-gray-900 dark:text-white">
                {t('prd.exampleText', { fileName })}
              </p>
            </div>
          </div>
