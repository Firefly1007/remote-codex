      ...
      <div className="relative w-full max-w-md rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
        <div className="p-6">
          <div className="mb-4 flex items-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t('prd.fileExists')}</h3>
          </div>

          <p className="mb-6 text-sm text-gray-600 dark:text-gray-400">
            {t('prd.overwriteMessage', { fileName })}
          </p>
          ...
          <div className="flex justify-end gap-3">
            ...
            >
              ...
              <span>{saving ? t('prd.saving') : t('prd.overwrite')}</span>
            </button>
          </div>
        </div>
      </div>
