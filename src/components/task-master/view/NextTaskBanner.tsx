...
function PriorityIndicator({ priority }: { priority?: string }) {
  ...
  if (priority === 'high') {
    return (
      <div className="flex h-4 w-4 items-center justify-center rounded bg-red-100 dark:bg-red-900/50" title={t('task.highPriority')}>
  ...
  if (priority === 'medium') {
    return (
      <div className="flex h-4 w-4 items-center justify-center rounded bg-amber-100 dark:bg-amber-900/50" title={t('task.mediumPriority')}>
  ...
  return (
    <div className="flex h-4 w-4 items-center justify-center rounded bg-gray-100 dark:bg-gray-800" title={t('task.lowPriority')}>
        ...
        <div className={cn('bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-3 mb-4', className)}>
          <div className="flex items-center justify-between gap-3">
            <div className="flex min-w-0 items-center gap-2">
              ...
              <p className="text-sm font-medium text-gray-900 dark:text-white">{t('tasks.banner.notConfigured')}</p>
            </div>
          ...
          >
            ...
            {showSetupDetails ? t('tasks.banner.hideDetails') : t('tasks.banner.whatIs')}
          </button>

          {showSetupDetails && (
            <div className="mt-3 space-y-1 text-xs text-blue-900 dark:text-blue-100">
              <p>- {t('tasks.banner.feature1')}</p>
              <p>- {t('tasks.banner.feature2')}</p>
              <p>- {t('tasks.banner.feature3')}</p>
            </div>
          )}
        </div>
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="min-w-0 flex-1">
              <div className="mb-1 flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-slate-600 dark:text-slate-400">{t('task.taskPrefix')} {nextTask.id}</span>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-gray-900 dark:text-white">
              {completedTasks === tasks.length ? t('task.allComplete') : t('task.noPending')}
            </span>
          </div>
          <div className="flex items-center gap-2">
