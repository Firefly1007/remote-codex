        ...
        <div className="space-y-6 p-6">
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="mb-2 font-semibold text-blue-900 dark:text-blue-100">{t('createTask.proTip')}</h4>
                ...
                <div className="rounded border border-blue-200 bg-white p-3 dark:border-blue-700 dark:bg-gray-800">
                  <p className="mb-1 text-xs font-medium text-gray-600 dark:text-gray-400">{t('createTask.example')}</p>
                  <p className="font-mono text-sm text-gray-900 dark:text-white">
                    {t('createTask.exampleText')}
                  </p>
                </div>
              </div>
            </div>
